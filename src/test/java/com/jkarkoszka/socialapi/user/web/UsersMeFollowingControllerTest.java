...
class UsersMeFollowingControllerTest {
    ...
    public void shouldAddNewFollowingUser() throws Exception {
        ...
        AddUserFollowingRestRequest addUserFollowingRestRequest = new AddUserFollowingRestRequest(newFollowingUserIdAsHexString);

        //when
        var result = mvc.perform(post("/users/me/followingUsers")
                .header("X-Current-User-Id", currentUserId)
                .content(objectMapper.writeValueAsString(addUserFollowingRestRequest))
